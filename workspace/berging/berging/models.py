...
class Scenario(models.Model):
    ...
    neerslag = models.CharField(max_length=1,choices=NEERSLAG,default='g',verbose_name='neerslagtekort')
    bodem = models.CharField(max_length=1,choices=BODEMTYPE,default='z',verbose_name='grondsoort')
    kwaliteit = models.CharField(max_length=1,choices=KWALITEIT,default='f',verbose_name='grondwaterkwaliteit')
    irrigatie = models.CharField(max_length=1,choices=IRRIGATIE,default='d',verbose_name='type irrigatie')

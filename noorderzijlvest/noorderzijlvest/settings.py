"""
Django settings for noorderzijlvest project.
...
ROOT_URLCONF = 'noorderzijlvest.urls'

WSGI_APPLICATION = 'noorderzijlvest.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'noorderzijlvest',                      # Or path to database file if using sqlite3.
...
# voor plaatjes website provincie: noorderzijlvest.acaciadata.com/img/management.png
IMG_URL = '/img/'
IMG_ROOT = os.path.join(os.path.dirname(BASE_DIR),'img')

# Grapelli admin
GRAPPELLI_ADMIN_TITLE='Beheer van Noorderzijlvest meetnet'

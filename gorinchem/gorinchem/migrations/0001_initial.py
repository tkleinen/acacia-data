...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gorinchem_network', (
        ...
        db.send_create_signal(u'gorinchem', ['Network'])

        # Adding model 'UserProfile'
        db.create_table(u'gorinchem_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'gorinchem', ['UserProfile'])

        # Adding M2M table for field network on 'UserProfile'
        m2m_table_name = db.shorten_name(u'gorinchem_userprofile_network')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'gorinchem.userprofile'], null=False)),
            ('network', models.ForeignKey(orm[u'gorinchem.network'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'network_id'])

        # Adding model 'Well'
        db.create_table(u'gorinchem_well', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gorinchem.Network'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ...
        db.send_create_signal(u'gorinchem', ['Well'])

        # Adding model 'Photo'
        db.create_table(u'gorinchem_photo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('well', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gorinchem.Well'])),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'gorinchem', ['Photo'])

        # Adding model 'Screen'
        db.create_table(u'gorinchem_screen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('well', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gorinchem.Well'])),
        ...
        db.send_create_signal(u'gorinchem', ['Screen'])

        # Adding unique constraint on 'Screen', fields ['well', 'nr']
        db.create_unique(u'gorinchem_screen', ['well_id', 'nr'])

        # Adding model 'Datalogger'
        db.create_table(u'gorinchem_datalogger', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('screen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gorinchem.Screen'], null=True, blank=True)),
        ...
        db.send_create_signal(u'gorinchem', ['Datalogger'])

        # Adding model 'LoggerDatasource'
        db.create_table(u'gorinchem_loggerdatasource', (
            ...
            ('logger', self.gf('django.db.models.fields.related.ForeignKey')(related_name='datasources', to=orm['gorinchem.Datalogger'])),
        ))
        db.send_create_signal(u'gorinchem', ['LoggerDatasource'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'gorinchem_screen', ['well_id', 'nr'])

        # Deleting model 'Network'
        db.delete_table(u'gorinchem_network')

        # Deleting model 'UserProfile'
        db.delete_table(u'gorinchem_userprofile')

        # Removing M2M table for field network on 'UserProfile'
        db.delete_table(db.shorten_name(u'gorinchem_userprofile_network'))

        # Deleting model 'Well'
        db.delete_table(u'gorinchem_well')

        # Deleting model 'Photo'
        db.delete_table(u'gorinchem_photo')

        # Deleting model 'Screen'
        db.delete_table(u'gorinchem_screen')

        # Deleting model 'Datalogger'
        db.delete_table(u'gorinchem_datalogger')

        # Deleting model 'LoggerDatasource'
        db.delete_table(u'gorinchem_loggerdatasource')
    ...
    models = {
        ...
        u'gorinchem.channel': {
            ...
            'monfile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gorinchem.MonFile']"}),

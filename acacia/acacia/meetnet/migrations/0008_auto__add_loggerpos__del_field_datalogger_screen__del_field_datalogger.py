...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LoggerPos'
        db.create_table(u'meetnet_loggerpos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetnet.Datalogger'])),
        ...
        db.send_create_signal(u'meetnet', ['LoggerPos'])

        # Deleting field 'Datalogger.screen'
        db.delete_column(u'meetnet_datalogger', 'screen_id')

        # Deleting field 'Datalogger.date'
        db.delete_column(u'meetnet_datalogger', 'date')

        # Adding unique constraint on 'Datalogger', fields ['serial']
        db.create_unique(u'meetnet_datalogger', ['serial'])
        ...
        # Adding field 'MonFile.source'
        db.add_column(u'meetnet_monfile', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['meetnet.LoggerPos']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Datalogger', fields ['serial']
        db.delete_unique(u'meetnet_datalogger', ['serial'])

        # Deleting model 'LoggerPos'
        db.delete_table(u'meetnet_loggerpos')

        # Adding field 'Datalogger.screen'
        db.add_column(u'meetnet_datalogger', 'screen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetnet.Screen'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datalogger.date'
        db.add_column(u'meetnet_datalogger', 'date',
        ...
        # Deleting field 'MonFile.source'
        db.delete_column(u'meetnet_monfile', 'source_id')
    ...
    models = {
        ...
        u'meetnet.monfile': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetnet.LoggerPos']"}),

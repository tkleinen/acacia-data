...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualSeries'
        db.create_table(u'meetnet_manualseries', (
        ...
        db.send_create_signal(u'meetnet', ['ManualSeries'])


    def backwards(self, orm):
        # Deleting model 'ManualSeries'
        db.delete_table(u'meetnet_manualseries')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Well.refpnt'
        db.delete_column(u'meetnet_well', 'refpnt')

        # Adding field 'Well.description'
        db.add_column(u'meetnet_well', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Screen.refpnt'
        db.add_column(u'meetnet_screen', 'refpnt',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Well.refpnt'
        db.add_column(u'meetnet_well', 'refpnt',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'Well.description'
        db.delete_column(u'meetnet_well', 'description')

        # Deleting field 'Screen.refpnt'
        db.delete_column(u'meetnet_screen', 'refpnt')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Well.maaiveld'
        db.alter_column(u'meetnet_well', 'maaiveld', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Well.date'
        db.alter_column(u'meetnet_well', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Well.maaiveld'
        db.alter_column(u'meetnet_well', 'maaiveld', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Well.date'
        db.alter_column(u'meetnet_well', 'date', self.gf('django.db.models.fields.DateField')(default=0))
    ...
    models = {
        ...
        u'meetnet.loggerpos': {
            ...
            'refpnt': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'meetnet.screen': {
            ...
            'bottom': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'diameter': ('django.db.models.fields.FloatField', [], {'default': '32', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'refpnt': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'top': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'well': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetnet.Well']"})
        },
        u'meetnet.well': {
            ...
            'maaiveld': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),

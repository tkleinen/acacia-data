...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.bound'
        db.alter_column(u'meetnet_network', 'bound', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'Network.bound'
        db.alter_column(u'meetnet_network', 'bound', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Well.g'
        db.add_column(u'meetnet_well', 'g',
                      self.gf('django.db.models.fields.FloatField')(default=9.80665),
                      keep_default=False)

        # Adding field 'Screen.density'
        db.add_column(u'meetnet_screen', 'density',
                      self.gf('django.db.models.fields.FloatField')(default=1000.0),
                      keep_default=False)


        # Changing field 'LoggerPos.end_date'
        db.alter_column(u'meetnet_loggerpos', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'MonFile.source'
        db.alter_column(u'meetnet_monfile', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetnet.LoggerPos'], null=True))

    def backwards(self, orm):
        # Deleting field 'Well.g'
        db.delete_column(u'meetnet_well', 'g')

        # Deleting field 'Screen.density'
        db.delete_column(u'meetnet_screen', 'density')


        # Changing field 'LoggerPos.end_date'
        db.alter_column(u'meetnet_loggerpos', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 6, 0, 0)))

        # Changing field 'MonFile.source'
        db.alter_column(u'meetnet_monfile', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['meetnet.LoggerPos']))

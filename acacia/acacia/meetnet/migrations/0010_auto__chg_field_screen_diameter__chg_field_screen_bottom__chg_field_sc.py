...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Screen.diameter'
        db.alter_column(u'meetnet_screen', 'diameter', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Screen.bottom'
        db.alter_column(u'meetnet_screen', 'bottom', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Screen.refpnt'
        db.alter_column(u'meetnet_screen', 'refpnt', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Screen.top'
        db.alter_column(u'meetnet_screen', 'top', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Screen.diameter'
        db.alter_column(u'meetnet_screen', 'diameter', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Screen.bottom'
        db.alter_column(u'meetnet_screen', 'bottom', self.gf('django.db.models.fields.FloatField')(default=32))

        # Changing field 'Screen.refpnt'
        db.alter_column(u'meetnet_screen', 'refpnt', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Screen.top'
        db.alter_column(u'meetnet_screen', 'top', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        u'meetnet.loggerpos': {
            'Meta': {'ordering': "['logger', 'start_date']", 'object_name': 'LoggerPos'},
            'baro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.Series']", 'null': 'True', 'blank': 'True'}),
            'depth': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetnet.Datalogger']"}),
        ...
        u'meetnet.monfile': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetnet.LoggerPos']", 'null': 'True', 'blank': 'True'}),
        ...
        u'meetnet.screen': {
            ...
            'bottom': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'chart': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'density': ('django.db.models.fields.FloatField', [], {'default': '1000.0'}),
            'diameter': ('django.db.models.fields.FloatField', [], {'default': '32', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material': ('django.db.models.fields.CharField', [], {'default': "'pvc'", 'max_length': '10', 'blank': 'True'}),
            'nr': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'refpnt': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'top': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'well': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['meetnet.Well']"})
        },
        u'meetnet.well': {
            ...
            'g': ('django.db.models.fields.FloatField', [], {'default': '9.80665'}),

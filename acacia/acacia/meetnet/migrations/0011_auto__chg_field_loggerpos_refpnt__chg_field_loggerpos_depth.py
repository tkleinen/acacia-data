...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LoggerPos.refpnt'
        db.alter_column(u'meetnet_loggerpos', 'refpnt', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'LoggerPos.depth'
        db.alter_column(u'meetnet_loggerpos', 'depth', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'LoggerPos.refpnt'
        db.alter_column(u'meetnet_loggerpos', 'refpnt', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'LoggerPos.depth'
        db.alter_column(u'meetnet_loggerpos', 'depth', self.gf('django.db.models.fields.FloatField')())

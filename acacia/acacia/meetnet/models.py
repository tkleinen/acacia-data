...
class MonFile(SourceFile):
    ...
    compstat = models.CharField(max_length=10, blank=True, null=True)
    ...
    sample_period = models.CharField(max_length=50, blank=True, null=True)
    sample_method = models.CharField(max_length=10, blank=True, null=True)

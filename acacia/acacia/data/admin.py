...
class ParameterSeriesAdmin(PolymorphicChildModelAdmin):
    #actions = [actions.copy_series, actions.download_series, actions.download_series_csv, actions.refresh_series, actions.replace_series, actions.series_thumbnails, actions.update_series_properties, actions.empty_series]
...
class SeriesAdmin(PolymorphicParentModelAdmin):
    actions = [actions.create_grid, actions.copy_series, actions.download_series, actions.download_series_csv, actions.download_series_zip, actions.refresh_series, actions.replace_series, actions.series_thumbnails, actions.update_series_properties, actions.empty_series]

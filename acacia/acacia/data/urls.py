...
from .views import DataFileAddView, DataFileDetailView, ProjectDetailView, ProjectLocatieDetailView, MeetLocatieDetailView, ChartView, ChartBareView, DashView, SeriesView
...
urlpatterns = patterns('acacia.data.views',
    ...
    url(r'^add/$', DataFileAddView.as_view(), name='data-add'),

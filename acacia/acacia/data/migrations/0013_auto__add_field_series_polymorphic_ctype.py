...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.polymorphic_ctype'
        db.add_column(u'data_series', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_data.series_set+', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.polymorphic_ctype'
        db.delete_column(u'data_series', 'polymorphic_ctype_id')

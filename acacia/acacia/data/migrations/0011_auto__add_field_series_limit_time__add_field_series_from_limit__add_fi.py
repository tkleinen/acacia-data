...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.limit_time'
        db.add_column(u'data_series', 'limit_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Series.from_limit'
        db.add_column(u'data_series', 'from_limit',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Series.to_limit'
        db.add_column(u'data_series', 'to_limit',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.limit_time'
        db.delete_column(u'data_series', 'limit_time')

        # Deleting field 'Series.from_limit'
        db.delete_column(u'data_series', 'from_limit')

        # Deleting field 'Series.to_limit'
        db.delete_column(u'data_series', 'to_limit')

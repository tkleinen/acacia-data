...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Grid'
        db.create_table(u'data_grid', (
            (u'chart_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data.Chart'], unique=True, primary_key=True)),
            ('colwidth', self.gf('django.db.models.fields.FloatField')()),
            ('rowheight', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'data', ['Grid'])


    def backwards(self, orm):
        # Deleting model 'Grid'
        db.delete_table(u'data_grid')
    ...
    models = {
        ...
        u'data.grid': {
            ...
            'colwidth': ('django.db.models.fields.FloatField', [], {}),
            'rowheight': ('django.db.models.fields.FloatField', [], {})
        },
        u'data.manualseries': {

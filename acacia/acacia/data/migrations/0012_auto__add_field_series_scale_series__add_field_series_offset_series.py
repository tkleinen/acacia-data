...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Series.scale_series'
        db.add_column(u'data_series', 'scale_series',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scaling_set', null=True, to=orm['data.Series']),
                      keep_default=False)

        # Adding field 'Series.offset_series'
        db.add_column(u'data_series', 'offset_series',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='offset_set', null=True, to=orm['data.Series']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Series.scale_series'
        db.delete_column(u'data_series', 'scale_series_id')

        # Deleting field 'Series.offset_series'
        db.delete_column(u'data_series', 'offset_series_id')

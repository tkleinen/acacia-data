...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectLocatie.dashboard'
        db.add_column(u'data_projectlocatie', 'dashboard',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.TabGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectLocatie.dashboard'
        db.delete_column(u'data_projectlocatie', 'dashboard_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chart.polymorphic_ctype'
        db.add_column(u'data_chart', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_data.chart_set+', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chart.polymorphic_ctype'
        db.delete_column(u'data_chart', 'polymorphic_ctype_id')

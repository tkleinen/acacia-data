...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grid.unit'
        db.add_column(u'data_grid', 'unit',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Grid.zmin'
        db.add_column(u'data_grid', 'zmin',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Grid.zmax'
        db.add_column(u'data_grid', 'zmax',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grid.unit'
        db.delete_column(u'data_grid', 'unit')

        # Deleting field 'Grid.zmin'
        db.delete_column(u'data_grid', 'zmin')

        # Deleting field 'Grid.zmax'
        db.delete_column(u'data_grid', 'zmax')
    ...
    models = {
        ...
        u'data.grid': {
            ...
            'unit': ('django.db.models.fields.CharField', [], {'default': "'Ωm'", 'max_length': '20', 'blank': 'True'}),

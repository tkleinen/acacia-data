...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datasource.timezone'
        db.add_column(u'data_datasource', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='Europe/Amsterdam', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasource.timezone'
        db.delete_column(u'data_datasource', 'timezone')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ManualSeries.locatie'
        db.delete_column(u'data_manualseries', 'locatie_id')

        # Deleting field 'Formula.locatie'
        db.delete_column(u'data_formula', 'locatie_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ManualSeries.locatie'
        raise RuntimeError("Cannot reverse this migration. 'ManualSeries.locatie' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ManualSeries.locatie'
        db.add_column(u'data_manualseries', 'locatie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.MeetLocatie']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Formula.locatie'
        raise RuntimeError("Cannot reverse this migration. 'Formula.locatie' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Formula.locatie'
        db.add_column(u'data_formula', 'locatie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.MeetLocatie']),
                      keep_default=False)

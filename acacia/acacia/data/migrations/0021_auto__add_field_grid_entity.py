...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grid.entity'
        db.add_column(u'data_grid', 'entity',
                      self.gf('django.db.models.fields.CharField')(default='Weerstand', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grid.entity'
        db.delete_column(u'data_grid', 'entity')

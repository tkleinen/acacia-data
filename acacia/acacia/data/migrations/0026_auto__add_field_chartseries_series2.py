...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChartSeries.series2'
        db.add_column(u'data_chartseries', 'series2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='series2', null=True, to=orm['data.Series']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChartSeries.series2'
        db.delete_column(u'data_chartseries', 'series2_id')
    ...
    models = {
        ...
        u'data.chartseries': {
            ...
            'series2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'series2'", 'null': 'True', 'to': u"orm['data.Series']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeriesProperties'
        db.create_table(u'data_seriesproperties', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('series', self.gf('django.db.models.fields.related.OneToOneField')(related_name='properties', unique=True, to=orm['data.Series'])),
            ('aantal', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('min', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('max', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('van', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('tot', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('gemiddelde', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('eerste', self.gf('django.db.models.fields.related.ForeignKey')(related_name='first', null=True, to=orm['data.DataPoint'])),
            ('laatste', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last', null=True, to=orm['data.DataPoint'])),
            ('beforelast', self.gf('django.db.models.fields.related.ForeignKey')(related_name='beforelast', null=True, to=orm['data.DataPoint'])),
        ))
        db.send_create_signal(u'data', ['SeriesProperties'])


    def backwards(self, orm):
        # Deleting model 'SeriesProperties'
        db.delete_table(u'data_seriesproperties')
